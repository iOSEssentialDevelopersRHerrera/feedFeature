...
class CodableFeedStoreTests: XCTestCase {
    ...
    func test_insert_overridesPreviouslyInsertedCacheValues() {
        ...
        let firsInsertionError = insert((uniqueImageFeed().local, Date()), to: sut)
        XCTAssertNil(firsInsertionError, "Expected to inset cache successfully")
    ...
    func test_insert_deliversErrorOnInsertionError() {
        let invalidStoreURL = URL(string: "invalids://store-url")
    ...
    func test_delete_deliversErrorOnDeletionError() {
        ...
        XCTAssertNotNil(deletionError, "Expected cache to fail")
    ...
    private func deleteCahe(form sut: FeedStore) ->Error? {
